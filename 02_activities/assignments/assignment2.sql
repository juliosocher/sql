...
/* the previous query did not have the product_size on it, so I just filtered from the entire list */
SELECT 
    product_name,
    product_size
FROM product
...
/* Missed adding the product_category_id just to see how it would populate it :) */
